...
declare module 'motia' {
  ...
  interface Handlers {
    'TesterAPI': ApiRouteHandler<Record<string, unknown>, ApiResponse<200, { message: string; status: string; customMessage: string }>, never>
    ...
    'GenerateCrewAPI': ApiRouteHandler<Record<string, unknown>, unknown, never>
  }
